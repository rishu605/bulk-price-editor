...
export type AnchorProductVariantsPageQuery = { product?: AdminTypes.Maybe<{ featuredImage?: AdminTypes.Maybe<Pick<AdminTypes.Image, 'url'>>, variants: { pageInfo: Pick<AdminTypes.PageInfo, 'hasNextPage' | 'endCursor'>, nodes: Array<(
...
export type AnchorCatalogPageQuery = { products: { pageInfo: Pick<AdminTypes.PageInfo, 'hasNextPage' | 'endCursor'>, nodes: Array<(
      Pick<AdminTypes.Product, 'id' | 'title' | 'vendor' | 'productType' | 'status' | 'tags' | 'updatedAt' | 'isGiftCard'>
      & { featuredImage?: AdminTypes.Maybe<Pick<AdminTypes.Image, 'url'>>, collections: { nodes: Array<Pick<AdminTypes.Collection, 'id'>> }, variants: { pageInfo: Pick<AdminTypes.PageInfo, 'hasNextPage' | 'endCursor'>, nodes: Array<(
          Pick<AdminTypes.ProductVariant, 'id' | 'title' | 'sku' | 'barcode' | 'price' | 'compareAtPrice' | 'inventoryQuantity'>
          & { image?: AdminTypes.Maybe<Pick<AdminTypes.Image, 'url'>>, inventoryItem: { unitCost?: AdminTypes.Maybe<Pick<AdminTypes.MoneyV2, 'amount' | 'currencyCode'>> } }
        )> } }
    )> } };
...
export type AnchorShopCurrencyQuery = { shop: (
...
export type AnchorGiftCardProductsQueryVariables = AdminTypes.Exact<{
  cursor?: AdminTypes.InputMaybe<AdminTypes.Scalars['String']['input']>;
}>;


export type AnchorGiftCardProductsQuery = { products: { pageInfo: Pick<AdminTypes.PageInfo, 'hasNextPage' | 'endCursor'>, nodes: Array<(
      Pick<AdminTypes.Product, 'id' | 'title' | 'isGiftCard'>
      & { variants: { pageInfo: Pick<AdminTypes.PageInfo, 'hasNextPage'>, nodes: Array<Pick<AdminTypes.ProductVariant, 'id'>> } }
    )> } };
